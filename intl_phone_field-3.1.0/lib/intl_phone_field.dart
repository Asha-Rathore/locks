...
class IntlPhoneField extends StatefulWidget {
  ...
  IntlPhoneField({
    ...
    this.flagsButtonMargin = EdgeInsets.zero, this.borderColor,
  }) : super(key: key);
  ...
  Container _buildFlagsButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Color(0xff024023).withOpacity(0.6),
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: widget.borderColor ?? Color(0xff024023)),
      ),
